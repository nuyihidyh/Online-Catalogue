...
<meta charset="utf-8">
  ...
  <title>Women Watch Shop : Orders</title>
   <!-- Bootstrap -->
    ...
    <form action="orders.php" method="post" class="form-horizontal">
      <div class="form-group">
        <label for="orderid" class="col-sm-3 control-label">Order ID</label>
          <div class="col-sm-9">
       <input name="oid" type="text" readonly value="<?php if(isset($_GET['edit'])) echo $editrow['fld_order_id']; ?>"> 
      </div>
        </div>
      <div class="form-group">
 ...
 <div class="row">
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      try {
        $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $sql = "SELECT * FROM tbl_orders_a149771, tbl_staffs_a149771, tbl_customers_a149771 WHERE ";
        $sql = $sql."tbl_orders_a149771.fld_staff_id = tbl_staffs_a149771.fld_staff_id and ";
        $sql = $sql."tbl_orders_a149771.fld_customer_id = tbl_customers_a149771.fld_customer_id";
